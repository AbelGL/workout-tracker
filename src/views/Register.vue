  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    >
      ...
      <div class="flex flex-col mb-2">
        <label for="email" class="mb-1 text-sm text-at-ligh-green">Email</label>
        <input
          type="text"
          required
      ...
      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm text-at-ligh-green"
          >Password</label
        >
        <input
          type="password"
      ...
      <div class="flex flex-col mb-2">
        <label for="confirmPassword" class="mb-1 text-sm text-at-ligh-green"
